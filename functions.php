...
function custom_search_results_date_replacement( $the_date, $format, $post ) {
  // Check if we are on the search results page and the post type is a 'page'
  if ( is_search() && $post->post_type === 'page' ) {
      return __( 'Page', 'your-text-domain' );
  }
