...
<html <?php language_attributes(); ?>>
	<head>
        ...
        <link rel="stylesheet" href="https://use.typekit.net/dxk2lhf.css">
		<?php wp_head() ?>
	</head>
<body <?php body_class(); ?>>
				...
				<div class="navbar-wrapper clearfix">
						...
						<div class="navbar-brand">
							...
							if ( has_custom_logo() ) :
								...
								<?php if (is_front_page()) { ?>
									<img class="voa-logo" src="<?php echo get_stylesheet_directory_uri(  ); ?>/assets/images/voice-of-agriculture.svg" alt="Voice of Agriculture">
								<?php  } else { ?>
								<img class="voa-logo" src="<?php echo get_stylesheet_directory_uri(  ); ?>/assets/images/voice-of-agriculture-black.svg" alt="Voice of Agriculture">
								<?php } ?>
                                </a>
					...
					<?php endif; ?>
					 <div class="search-form-dropdown">
						<?php if (is_front_page()) { ?>
							<img class="search-toggle" src="<?php echo get_stylesheet_directory_uri(  ); ?>/assets/images/white-search-icon.svg" />
						<?php } else { ?>
					 <img class="search-toggle" src="<?php echo get_stylesheet_directory_uri(  ); ?>/assets/images/black-search-icon.svg" />
